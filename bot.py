...
class Bot:
    ...
    # Отправка сообщений:
    def send_message(self, peer_id: int or list, message: str = None, keyboard = None, attachment: str = None, random_id: int = random.randint(0, 2147483647),
        ...
        self.execute_api("messages.send",
    ...
    def answer(self, message: str = None, keyboard = None, attachment: str = None, random_id: int = random.randint(0, 2147483647),
                     reply_id: int = None, forward_messages = None, sticker_id: int = None, payload = None, dont_parse_links: int = None, disable_mentions: int = None):
